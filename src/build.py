...
PAGES = [
    ...
    ("barber-school-queens-ny.html", "location-queens.html",
     ...
     "ABI is just 30 minutes from Queens. NYS-licensed since 1996 — 500-hour Master Barber training with payment plans from $150/week. Tour the Manhattan campus today.",
     "en", []),
    ("barber-school-brooklyn-new-york.html", "location-brooklyn.html",
     "Barber School Near Brooklyn, New York — Start a Career That Pays",
     "Minutes from Brooklyn by subway — ABI's family-owned, NYS-licensed barber school has trained professionals since 1996. 500-hour program, $150/week plans.",
     "en", []),
    ...
    ("barber-school-westchester-ny.html", "location-westchester.html",
     "Barber School Near Westchester, NY — Master Barber in 4 Months",
     "Westchester County students train at ABI's nearby Bronx campus. Become a licensed Master Barber in about 4 months — 500-hour NYS-approved program from $150/week.",
     "en", []),
    ...
    ("barber-school-connecticut.html", "location-connecticut.html",
     "Barber School for Connecticut — Train in NY, Transfer Your License",
     "Connecticut residents: earn a NY barber license in half the time and up to half the cost, then transfer home through reciprocity. ABI's 500-hour program from $150/week.",
     "en", []),
    ("barber-school-pennsylvania.html", "location-pennsylvania.html",
     "Barber School for Pennsylvania — License Transfer & Reciprocity",
     "NY-licensed barbers: transfer to Pennsylvania via reciprocity — save ~$10,400 and 700 training hours vs a full PA program. ABI guides you through the process.",
     "en", []),
