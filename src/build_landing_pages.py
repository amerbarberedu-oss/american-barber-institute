...
S = {
 "en": {
  ...
  "f_about": "New York's career-focused barber school — changing lives for over 30 years. Licensed by the New York State Department of Education. Est. 1996.",
...
_LOCATIONS_ARCHIVED = [
 {"slug":"barber-school-queens-ny","loc":"Queens, NY","h1":"Barber School for Queens Residents","campus":MANHATTAN,
  ...
  "desc":"Train as a licensed Master Barber at NYC's career-focused barber school — a quick train ride from Queens to Midtown Manhattan. 500-hour program, flexible schedules, payment plans. Next class starts soon.",
  "intro":["From Astoria and Long Island City to Jackson Heights, Flushing and Jamaica — Queens residents train for a real career behind the chair at one of New York City's career-focused barber schools, just a quick ride away in Midtown Manhattan.",
 ...
 {"slug":"barber-school-brooklyn-new-york","loc":"Brooklyn, NY","h1":"Barber School for Brooklyn, NY","campus":MANHATTAN,
  ...
  "intro":["From Williamsburg and Bushwick to Bed-Stuy, Flatbush, Bay Ridge and Coney Island — Brooklyn students train for a real career behind the chair at New York's career-focused barber school.",
...
<link rel="stylesheet" href="%sassets/css/landing.css?v=200">
<link rel="stylesheet" href="%sassets/css/upgrade.css?v=200">
