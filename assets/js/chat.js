...
(function () {
  ...
  var CSS = '' +
    ...
    '.abichat-rail-ic{width:30px;height:30px;flex:0 0 auto;display:flex;align-items:center;justify-content:center}' +
    '.abichat-rail-ic svg{width:16px;height:16px;display:block}' +
